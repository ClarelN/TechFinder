...
class UtilisateurTest extends TestCase
{
    ...
    public function test_can_create_utilisateur(): void
    {
        ...
        $response->assertStatus(201)
                 ->assertJsonFragment(['code_user' => 'USR001']);

        $this->assertDatabaseHas('utilisateurs', ['code_user' => 'USR001']);
    }

    public function test_fails_to_create_with_duplicate_code_user(): void
    {
        Utilisateur::factory()->create(['code_user' => 'USR001', 'login_user' => 'other.login']);
    ...
    public function test_fails_to_create_with_missing_required_fields(): void
    {
        ...
        $response->assertStatus(422)
                 ->assertJsonValidationErrors(['code_user', 'nom_user', 'login_user', 'password_user']);
    }
